...
if (defined('WPMU_PLUGIN_URL') && defined('WPMU_PLUGIN_DIR')) {
	...
	define ('WDEB_PLUGIN_BASE_DIR', WPMU_PLUGIN_DIR. '/' . WDEB_PLUGIN_SELF_DIRNAME, true);
	define ('WDEB_PLUGIN_URL', str_replace('http://', (@$_SERVER["HTTPS"] == 'on' ? 'https://' : 'http://'), WPMU_PLUGIN_URL) . '/' . WDEB_PLUGIN_SELF_DIRNAME, true);
