...
require_once dirname(__file__).DIRECTORY_SEPARATOR.'comment-spam-pack'.DIRECTORY_SEPARATOR.'avh-fdas-recaptcha.php';
require_once dirname(__file__).DIRECTORY_SEPARATOR.'comment-spam-pack'.DIRECTORY_SEPARATOR.'avh-fdas-spam-filter.php';
require_once dirname(__file__).DIRECTORY_SEPARATOR.'comment-spam-pack'.DIRECTORY_SEPARATOR.'avh-fdas-trackback-validation.php';
require_once dirname(__file__).DIRECTORY_SEPARATOR.'comments-control'.DIRECTORY_SEPARATOR.'comments-control.php';
