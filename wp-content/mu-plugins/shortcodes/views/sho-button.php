...
<form onsubmit="return false;" action="#">
	...
	<p>
		<span class="label">Background Color: </span>
			#<input type="text" name="bg_color" id="bg_color" class="color_scheme_input" value="00A7ED" />
	</p>
	
	<p>
		<span class="label">Font Color: </span>
			#<input type="text" name="font_color" id="font_color"  class="color_scheme_input" value="FFFFFF" />
	</p>
